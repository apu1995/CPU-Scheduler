...
public class RR1 extends Scheduler implements Runnable {

  
   public RR1(Vector q, statsFrame s, animeFrame a, inputFrame i, int c) {
      super(q,s,a,i,c);      
    
      thread = new Thread(this,"RR1");
      thread.start();
   } // constructor
   ...
   public void run() {
      ...
      st.report(finishQ,"Round Robin,q = 1");
      in.resetGUI();
   } // run thread
